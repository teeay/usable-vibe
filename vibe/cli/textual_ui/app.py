...
class VibeApp(App):  # noqa: PLR0904
    ...
    def __init__(
        ...
        **kwargs: Any,
        ...
        self._configure_update_and_promo(
    ...
    def _configure_update_and_promo(
        self,
        *,
    ...
    async def _apply_native_context_effects(self, event: BaseEvent) -> None:
        """Apply context-cleared side effects without the legacy EventHandler."""
        if isinstance(event, ContextClearedEvent):
            await self._on_context_cleared(event.plan_file_path)
